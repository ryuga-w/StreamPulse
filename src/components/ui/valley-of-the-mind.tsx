...
// "Waves" — generated with 21st.dev Shader Builder
// Pure WebGL1 canvas that fills parent, zero external dependencies.
...
// "Waves" exact preset specification
const DARK_WAVES_CONFIG = {
  colors: [
    [0.000, 0.482, 1.000],  // #007BFF
    [0.400, 1.000, 0.000],  // #66FF00
    [0.000, 1.000, 0.118],  // #00FF1E
    [0.000, 0.482, 1.000],
    [0.400, 1.000, 0.000],
    [0.000, 1.000, 0.118],
    [0.000, 0.482, 1.000],
  ...
  colorCount: 3.0,
  timeMultiplier: -1.07,
  shape: [1.86, 0.44, 0.74, 0.28] as [number, number, number, number],
  surface: [2.75, 1.20, 0.00, 1.40] as [number, number, number, number],
  finish: [4.49, 0.23, 0.002, 0.07] as [number, number, number, number],
  transform: [245.0, 5.88, 0.04, 1.0] as [number, number, number, number],
  offsetX: 0.19,
  offsetY: -0.23,
  cursorEffect: 4.0,
  cursorStrength: 0.38,
...
// Light Mode Waves preset: pastel cyan/electric azure with soft brightness
const LIGHT_WAVES_CONFIG = {
  colors: [
    [0.72, 0.88, 1.00],  // Ethereal sky azure
    [0.82, 0.98, 0.78],  // Soft mint green
    [0.76, 0.92, 0.98],  // Pastel cyan
    [0.72, 0.88, 1.00],
    [0.82, 0.98, 0.78],
    [0.76, 0.92, 0.98],
    [0.72, 0.88, 1.00],
  ...
  colorCount: 3.0,
  timeMultiplier: -0.85,
  shape: [1.60, 0.35, 0.74, 0.20] as [number, number, number, number],
  surface: [2.50, 1.05, 0.04, 1.15] as [number, number, number, number],
  finish: [4.49, 0.08, 0.002, 0.02] as [number, number, number, number],
  transform: [245.0, 5.88, 0.02, 1.0] as [number, number, number, number],
  offsetX: 0.19,
  offsetY: -0.23,
  cursorEffect: 4.0,
  cursorStrength: 0.30,
...
export function ShaderBackground({ className, theme = 'dark' }: ShaderBackgroundProps) {
  ...
  const config = isLight ? LIGHT_WAVES_CONFIG : DARK_WAVES_CONFIG
